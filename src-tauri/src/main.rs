...
use crate::controllers::{cut_disposition_controller::organize_cut_disposition, generate_g_code_controller::generate_g_code};
...
async fn main() -> Result<(), ()> {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            organize_cut_disposition, generate_g_code])
